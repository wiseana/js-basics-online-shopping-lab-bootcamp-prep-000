...
function placeOrder(cardNumber) {
  if (`${cardNumber}`==="undefined") {return "Sorry, we don't have a credit card on file for you."} else {var totalCart=total(); cart=[]; return `Your total cost is $${totalCart}, which will be charged to the card ${cardNumber}.`}
  }
